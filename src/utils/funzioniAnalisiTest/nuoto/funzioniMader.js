...
const calcTabTotali = (puntiSelected, lattatoTabTotali, grado) => {
    ...
    const passo100 = {val1: 100/velMs.val1, val2: 100/velMs.val2}
    ...
    return {
        ...
        passo1001: isFinite(passo100.val1) && lattatoTabTotali.lattato1!=="" ? toMMSS(passo100.val1) : "",
        passo1002: isFinite(passo100.val2) && lattatoTabTotali.lattato2!=="" ? toMMSS(passo100.val2) : "",
