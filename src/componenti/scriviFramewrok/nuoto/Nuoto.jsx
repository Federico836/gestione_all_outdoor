...
const Nuoto = () => {
    ...
    const [datiSingolaRiga, setDatiSingolaRiga] = useState({zona: {zona: 1, descrizione: "A1", min: 0, max: 0},
        serie: "", ripetizioni: "", distanza: "", recupero: "0:00", tempo: "0:00", passo: "", note: "",durationType: "TIME", intensity: "WARMUP",strokeType: "FREESTYLE",equipmentType: "NONE"})
    ...
    const salvaFramework = () => {
        dispatch(addFramework({listaRighe: listaRighe.map(riga => {return {...riga, passo: 0}}),
