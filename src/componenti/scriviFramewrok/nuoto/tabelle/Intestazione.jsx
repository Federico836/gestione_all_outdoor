    ...
    return (
        <div className={styles.containerGrid}>
            ...
            <fieldset className={styles.riquadroTest}>
                ...
                <div>
                    {t('scrivi-framework:nuoto:passo')} m/yrd ({toHHMMSS(tempoPer100m)}) <input type="text" /* value={toHHMMSS(tempoPer1000m)} */ /* onChange={e => setTempoPer1000m(e.target.value)} */ onBlur={onBlurTempo100m} />
                </div>
                <div>
