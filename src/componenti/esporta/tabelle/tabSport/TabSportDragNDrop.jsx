...
const Row = props => {
    ...
    return (
        <div className="containerTab" style={{backgroundColor: coloreRiga}}>    
            <div style={{border: '1px solid gray', width: '15%', textAlign: 'center', display: "flex", alignItems: "center"}} contentEditable={true}><span>{riga.zona}</span></div>
            ...
            <div style={{border: '1px solid gray', width: '15%', textAlign: 'center', display: "flex", alignItems: "center"}} contentEditable={true}><span>{riga.tempoDist}</span></div>
    ...
    return (
      <div style={{border: '1px solid gray', display: 'flex', flexDirection: 'column', width: '100%'}}>
        <div style={{display: 'flex', flexDirection: 'row', textAlign: 'center'}}> 
            ...
            <div style={{border: '1px solid gray', width: '15%', display: 'flex', justifyContent: "center", alignItems: "center"}}>{t('scrivi-framework:sport:serie')}</div>
            <div style={{border: '1px solid gray', width: '15%', display: 'flex', justifyContent: "center", alignItems: "center"}}>{t('scrivi-framework:sport:ripetizioni')}</div>
            <div style={{border: '1px solid gray', width: '15%', display: 'flex', justifyContent: "center", alignItems: "center"}}>{t('scrivi-framework:sport:tempo-dist')}</div>
