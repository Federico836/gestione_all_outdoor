...
const Intestazione = (props) => {
    ...
    const { setData, nomeFramework, setNomeFramework, nomeGara, setNomeGara } = props
    ...
    return (
        <div className={styles.containerGrid}>
            ...
            <div>
                {t('scrivi-framework:gara:nome-framework')} <input type="text" defaultValue={nomeFramework} onChange={e => setNomeFramework(e.target.value)} />
            </div>
        </div>
    )
}
