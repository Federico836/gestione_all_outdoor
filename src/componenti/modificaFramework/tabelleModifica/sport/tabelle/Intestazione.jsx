...
const Intestazione = (props) => {
    ...
    const { setData, nomeFramework, setNomeFramework, nomeSport, setNomeSport } = props
    ...
    return (
        <div className={styles.containerGrid}>
            ...
            <div>
                {t('scrivi-framework:sport:nome-framework')} <input type="text" value={nomeFramework} onChange={e => setNomeFramework(e.target.value)} />
            </div>
        </div>
    )
}
