...
import styles from './TabCombinatiTriDragNDrop.module.css'
...
const Row = (props) => {
    ...
    return (
        <div className={styles.containerTab} style={{backgroundColor: coloreRiga}}>    
            <div style={{border: '1px solid gray', width: '15%', textAlign: 'center', display: "flex", alignItems: "center"}}><span>{riga.sport}</span></div>
            <div style={{border: '1px solid gray', width: '8%', textAlign: 'center', display: "flex", alignItems: "center"}}><span>{riga.zona}</span></div>
    ...
    return (
      <div style={{border: '1px solid gray', display: 'flex', flexDirection: 'column', width: '100%'}}>
        <div style={{display: 'flex', flexDirection: 'row', textAlign: 'center'}}> 
            ...
            <div style={{border: '1px solid gray', width: '8%', display: 'flex', justifyContent: "center", alignItems: "center"}}>{t('scrivi-framework:combinati-tri:clona')}</div>
            <div style={{border: '1px solid gray', width: '8%', display: 'flex', justifyContent: "center", alignItems: "center"}}>{t('scrivi-framework:combinati-tri:modifica')}</div>
            <div style={{border: '1px solid gray', width: '8%', display: 'flex', justifyContent: "center", alignItems: "center"}}>{t('scrivi-framework:combinati-tri:elimina')}</div>
        </div>
