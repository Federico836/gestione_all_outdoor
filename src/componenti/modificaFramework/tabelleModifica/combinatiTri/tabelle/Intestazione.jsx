...
const Intestazione = (props) => {
    ...
    const { setData, nomeFramework, setNomeFramework } = props
    ...
    return (
        <div className={styles.containerGrid}>
            ...
            <div>
                {t('scrivi-framework:combinati-tri:nome-framework')} <input type="text" value={nomeFramework} onChange={e => setNomeFramework(e.target.value)} />
            </div>
        </div>
    )
}
