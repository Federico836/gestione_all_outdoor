...
const TabInserisciRiga = props => {
    ...
    useEffect(function cambiaVel() {
        ...
        const passo100 = toMMSS(100/velMs)

        const strokeLength = puntoCliccato.distanza/(puntoCliccato.tempo/(60/puntoCliccato.strokeFreq))

        setPuntoCliccato({...puntoCliccato, velKmh, velMs, passo100, strokeLength})
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{isFinite(puntoCliccato.velMs) ? puntoCliccato.passo100 : ""}</td>
